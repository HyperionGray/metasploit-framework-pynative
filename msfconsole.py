...
def main():
    ...
    if not os.environ.get('MSF_QUIET') and '-q' not in sys.argv and '--quiet' not in sys.argv:
        print("\n" + "="*70)
        print("  🐍 Metasploit Framework - PyNative")
        print("="*70)
        ...
        if not in_msf_env:
            ...
            print("    ✅ All MSF commands available in your shell")
            print("    ✅ Python-native module execution")
            print("    ✅ Easy access to transpiler tools")
